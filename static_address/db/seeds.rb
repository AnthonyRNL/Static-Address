...
Post.create(title: "Haahahah", user_id: 1, content: "This is Raina's post",   upvote: 0)
Post.create(title: "Das mah shiit", user_id: 1, content: "This is Anthony's post", upvote: 0)
Post.create(title: "Listen i da best", user_id: 1, content: "This is Matthew's post", upvote: 0)
Post.create(title: "i so good at musik", user_id: 1, content: "This is Steven's post",  upvote: 0)
